...
# if案例: 结合前面学习的输入输出及if条件判断的知识，完成B站登录功能的实现（正确账号和密码为 19999999999/666888）
# 正确的账号和密码
true_account = "19999999999"
...
if account != true_account or password != true_password:
    print("登录失败 !")
    print("账号或密码错误 !")
...
# if...else...案例: 结合前面学习的输入输出及if条件判断的知识，完成B站登录功能的实现（正确账号和密码为 19999999999/666888）
# 正确的账号和密码
true_account = "19999999999"
true_password = "666888"
